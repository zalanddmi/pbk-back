...
namespace PbkService.Migrations
{
    ...
    [Migration("20240504144124_AddTypeCardsValue_OperationDateDefaultValue")]
    partial class AddTypeCardsValue_OperationDateDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PbkService.Models.Operation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PbkService.Models.UserCard", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PbkService.Models.Operation", b =>
                {
                    b.HasOne("PbkService.Models.Outlet", "Outlet")
                        .WithMany()
                        .HasForeignKey("OutletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PbkService.Models.User", "User")
                        .WithMany("Operations")
